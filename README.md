...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/geedim-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15455&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/geedim-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `geedim` can be installed with:

```
conda install geedim
```

It is possible to list all of the versions of `geedim` available on your platform with:
